...
const routes: Routes = [
  ...
  {path: 'artist/:id', component: ArtistDiscographyComponent, canActivate: [GuardAuthService]}, //changed from 'artist' to 'artist/:id'
  {path: 'album/:id', component: AlbumComponent, canActivate: [GuardAuthService]}, //changed from 'album' to 'album/:id'
